<%@ Control Language="C#" AutoEventWireup="true" CodeFile="adm_getpersonalisedrecommendations.ascx.cs" Inherits="UserControl_adm_getpersonalisedrecommendations" %>
<style type="text/css">
            ...
            <table align="center" border="0">
                <tr>
                    <td class="auto-style1" colspan="4">
                        <asp:Label ID="Label16" runat="server" Font-Size="XX-Large" Text="Recommendations"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="Label17" runat="server" Font-Bold="True" ForeColor="#CC3300" Text="Result  :"></asp:Label>
                    </td>
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style1">
