<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Customer_Browse_Products.ascx.cs" Inherits="UserControl_Customer_Browse_Products" %>
<style type="text/css">
...
<body style="text-align: center">
    <p style="text-align: center">
                        <asp:Label ID="Label16" runat="server" Font-Size="XX-Large" Text="Browse Products"></asp:Label>
                    </p>
    <p style="text-align: center">
