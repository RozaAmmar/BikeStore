<%@ Control Language="C#" AutoEventWireup="true" CodeFile="adm_ClassifyCustomer.ascx.cs" Inherits="UserControl_adm_ClassifyCustomer" %>
<style type="text/css">
            ...
            <table class="table table-striped table-bordered">
                <tr>
                    <td class="auto-style1" colspan="4">
                        <asp:Label ID="Label16" runat="server" Font-Size="XX-Large" Text="Classify Customer"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="Label17" runat="server" Font-Bold="True" ForeColor="#CC3300" Text="Result Category :"></asp:Label>
                    </td>
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style1">
                        <asp:TextBox ID="txtcatname" runat="server" BackColor="#FFFF99" BorderStyle="Groove" Enabled="False" ReadOnly="True" Width="178px"></asp:TextBox>
                    </td>
                    <td class="auto-style1">&nbsp;</td>
                </tr>
            </table>
