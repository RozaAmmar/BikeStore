<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Customer_Register.ascx.cs" Inherits="UserControl_Customer_Register" %>
<style type="text/css">
    .auto-style1 {
        text-align: center;
    }
            ...
            <table align="center" border="0" class="table table-striped table-bordered">
                <tr>
                    <td class="auto-style1" colspan="4">
                        <asp:Label ID="Label16" runat="server" Font-Size="XX-Large" Text="Customer Register"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style1" colspan="4">
                ...
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="#CC3300" Text="UserName:"></asp:Label>
                    </td>
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style1">
                        <asp:TextBox ID="txtUserName" runat="server" ValidationGroup="cus_reg" Width="178px"></asp:TextBox>
                    </td>
                    <td class="auto-style1">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtUserName" ErrorMessage="*" ForeColor="Red" ValidationGroup="cus_reg"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="Label2" runat="server" Font-Bold="True" ForeColor="#CC3300" Text="Password :"></asp:Label>
                    </td>
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style1">
                        <asp:TextBox ID="txtPWD" runat="server" TextMode="Password" ValidationGroup="cus_reg" Width="178px"></asp:TextBox>
                    </td>
                    <td class="auto-style1">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPWD" ErrorMessage="*" ForeColor="Red" ValidationGroup="cus_reg"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="Label3" runat="server" Font-Bold="True" ForeColor="#CC3300" Text="FirstName:"></asp:Label>
                    </td>
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style1">
                ...
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="Label4" runat="server" Font-Bold="True" ForeColor="#CC3300" Text="LastName:"></asp:Label>
                    </td>
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style1">
                        <asp:TextBox ID="txtIncome" runat="server" TextMode="Number" Width="178px"></asp:TextBox>
                    </td>
                    <td class="auto-style1">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style1">
                        <asp:TextBox ID="txtChildren" runat="server" TextMode="Number" Width="178px"></asp:TextBox>
                    </td>
                    <td class="auto-style1">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style1">
                        <asp:TextBox ID="txtcar" runat="server" TextMode="Number" Width="178px"></asp:TextBox>
                    </td>
                    <td class="auto-style1">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style1">
                        <asp:TextBox ID="txtAge" runat="server" TextMode="Number" Width="178px"></asp:TextBox>
                    </td>
                    <td class="auto-style1">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style1">
                        <asp:Button ID="Button1" runat="server" Height="31px" OnClick="Button1_Click" Text="Register" ValidationGroup="cus_reg" Width="142px" />
                    </td>
                    <td class="auto-style1">&nbsp;</td>
                </tr>
                <tr>
